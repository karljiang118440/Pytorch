...
trainset = torchvision.datasets.CIFAR10(
    root='/media/jcq/Doc/DL_data/cifar/cifar-10-python.tar/cifar-10-python', train=True, download=False, transform=transform_train)
trainloader = torch.utils.data.DataLoader(
    trainset, batch_size=16, shuffle=True, num_workers=2)

testset = torchvision.datasets.CIFAR10(
    root='/media/jcq/Doc/DL_data/cifar/cifar-10-python.tar/cifar-10-python', train=False, download=False, transform=transform_test)
