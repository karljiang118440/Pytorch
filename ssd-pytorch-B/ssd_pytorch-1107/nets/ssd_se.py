...
#
from utils.attention import SEModule 

from utils.config import USE_SE
...
class SSD(nn.Module):
    ...
    def forward(self, x):
        ...
        attention = list()
        attention.append(self.SE1)
        attention.append(self.SE2)
        attention.append(self.SE3)
        attention.append(self.SE4)
        attention.append(self.SE5)
        attention.append(self.SE6)
